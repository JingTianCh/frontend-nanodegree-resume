...
var education = {
    ...
    display: function () {
        for (var index = 0; index < this.schools.length; index++) {
            ...
            $(".education-entry:last").append(HTMLschoolName.replace("%data%", this.schools[index].name) + formattedDegree);
            ...
            $(".education-entry:last").append(HTMLschoolMajor.replace("%data%", this.schools[index].major));
        }
        for (var index = 0; index < this.onlineCourses.length; index++) {
            ...
            $(".education-entry:last").append(HTMLonlineTitle.replace("%data%", this.onlineCourses[index].title) + formattedSchool);
            $(".education-entry:last").append(HTMLonlineDates.replace("%data%", this.onlineCourses[index].dates));
            $(".education-entry:last").append(HTMLonlineURL.replace("%data%", this.onlineCourses[index].url));
        }
    }
};
education.display();
